...
export default function ModalCookie({ show, setShow, cancel, setCancel }) {
      ...
      <div
        ...
        <p className="lg:text-sm md:text-base text-sm">
          ...
          <Link legacyBehavior href="/datenschutz">
            <a className="text-black font-bold ">Datenschutzerklärung</a>
          </Link>
        </p>
        <div className="flex text-sm my-6 space-x-6">
          <Link legacyBehavior href="/datenschutz">
            <a className="text-black font-bold  underline">Datenschutz</a>
          </Link>
          <Link legacyBehavior href="/impressum">
            <a className="text-black font-bold  underline">Impressum</a>
          </Link>
        </div>
        <div className="flex md:flex-row flex-col md:space-y-0 space-y-4 md:justify-between">
          ...
          <div
            onClick={aceptCookie}
            className="md:w-[16rem] w-full text-center py-2.5 text-white bg-blue-1 hover:cursor-pointer transition-all ease-in-out duration-200 hover:bg-opacity-90">
            Alles Akzeptieren
          </div>
        </div>
            ...
            <div className="flex">
              <div
                ...
                className={`pb-1 hover:cursor-pointer w-1/2 text-center ${
                  active == 0
                    ? " text-blue-1 font-bold border-blue-1 border-b-2 "
